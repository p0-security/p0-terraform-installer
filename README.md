...
- **Kubernetes** (`modules/kubernetes`)
  ...
  - Note: requires that AWS IAM management integration has already been configured.
...
- **AWS**
  ...
  - If installing the kubernetes integration, must be able to view/modify the targeted EKS cluster.
