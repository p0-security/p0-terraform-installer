okta = {
  ...
  tfauth = {
    ...
    # OKTAOKTA_API_PRIVATE_KEY must be in PEM format when it is output from the Okta UI
    # Alternatively, use the jwk-to-pem.py utility to convert a JWK private key to a PEM private key
    private_key_id = "OybI1XXQ90eoRVd9q4MDghlMcAL3CtXFZKO8qagYhnY"
  }
  native_app = {
...
p0 = {
  org_id                 = "michael-d-eng-7141"
  gcp_service_account_id = "106141354930392279110"
}

# Optional: account ID where IAM Identity Center lives (org management or delegated admin). Leave commented to use current account.
identity_center_parent_account_id = "448288574119"
...
// do we want more regions here?
regional_aws = {
  us-west-1 = {
    enabled_vpcs                    = ["vpc-0ea2738e353cfe759"]
    is_resource_explorer_aggregator = false
  }
  us-west-2 = {
    enabled_vpcs                    = ["vpc-06c57a7c02a896309"]
